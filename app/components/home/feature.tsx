                ...
                <div className="flex gap-6 mt-6 flex-col lg:flex-row relative items-center justify-between">
                    <div className="w-80 md:w-96 h-[32rem] rounded-xl relative overflow-hidden group">
                        ...
                        <div className="absolute bottom-0 left-0 w-full bg-black bg-opacity-70 p-4 rounded-b-xl h-40 md:h-36 translate-y-40 md:translate-y-40 group-hover:translate-y-0 transition-all">
                            ...
                            <p className="leading-6 text-gray-300 text-left text-lg font-medium font-sans">Get marriage permission online, Fill form,Submit Relevant Documents and get permission through Whatsapp. </p>
                        </div>
                    </div>
                    <div className="w-80 md:w-96 h-[32rem] rounded-lg relative overflow-hidden group">
                        ...
                        <div className="absolute bottom-0 left-0 w-full bg-black bg-opacity-70 p-4 rounded-b-xl hh-40 md:h-36 translate-y-40 md:translate-y-40  group-hover:translate-y-0 transition-all">
                            ...
                            <p className="leading-6 text-gray-300 text-left text-lg font-semibold font-sans">Get religious permission online, Fill form,Submit Relevant Documents and get permission through Whatsapp. </p>
                        </div>
                    </div>
                    <div className="w-80 md:w-96 h-[32rem] rounded-lg relative overflow-hidden group">
                        ...
                        <div className="absolute bottom-0 left-0 w-full bg-black bg-opacity-70 p-4 rounded-b-xl h-40 md:h-36 translate-y-40 md:translate-y-40  group-hover:translate-y-0 transition-all">
                            ...
                            <p className="leading-6 text-gray-300 text-left text-lg font-semibold font-sans">Get rally permission online, Fill form,Submit Relevant Documents and get permission through Whatsapp. </p>
                        </div>
                    </div>
                    <div className="w-80 md:w-96 h-[32rem] rounded-lg relative overflow-hidden group">
                        ...
                        <div className="absolute bottom-0 left-0 w-full bg-black bg-opacity-70 p-4 rounded-b-xl h-40 md:h-36 translate-y-40 md:translate-y-40  group-hover:translate-y-0 transition-all">
                            <h1 className="text-gray-300 text-left text-xl font-semibold font-sans">Cinema Hall</h1>
                            <p className="leading-6 text-gray-300 text-left text-lg font-semibold font-sans">Get cinema hall permission online, Fill form,Submit Relevant Documents and get permission through Whatsapp. </p>
                        </div>
                    </div>
                </div>
            </section>

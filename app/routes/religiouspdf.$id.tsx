    ...
    const ReligiousPdf = () => (
        <Document>
            <Page style={styles.body} size={'A4'} >
                ...
                <View style={styles.flexbox}>
                    <View style={styles.flexbox1}>
                        <Text style={styles.filenametext}>No.  EST-RLG-{`0000${form.id}`.substring(`0000${form.id}`.length - 4)}</Text>
                    </View>
                    <View style={styles.flexbox2}>
                    </View>
                    <View style={styles.flexbox3}>
                ...
                <View>
                    <Text style={styles.para}>Ref : EST-RLG-{`0000${form.id}`.substring(`0000${form.id}`.length - 4)}
                    </Text>
                </View>
                <View>
                    <Text style={styles.para}>Subject: Permission for Religious Event
                    </Text>
                </View>

                <View style={styles.dividertwo}></View>
                <View>
                    <Text style={styles.para}>&nbsp;&nbsp;&nbsp;&nbsp; Please see the representation cited, wherein it has been requested to grant permission for a Peaceful Religious Event At {form.event_address} through the following route {form.route_info} From {new Date(form.from_date).toJSON().slice(0, 10).split('-').reverse().join('/')} To {new Date(form.to_date).toJSON().slice(0, 10).split('-').reverse().join('/')}.
                    </Text>
                </View>

    ...
    <>
      <div className="min-h-screen w-full bg-[#eeeeee] grid place-items-center">
        <div className="p-6 rounded-md shadow-md hover:shadow-xl hover:scale-105 transition-all bg-white border-t-4 border-purple-500">
          ...
          <p className="text-lg my-4 text-gray-700 text-center">
            Sign in to start you session
          </p>
          ...
          {isLoading ? (
            <button className="inline-block text-center text-white bg-purple-500 py-2 px-6 text-xl font-medium rounded-md w-full mt-6">
              Loading...
            </button>
          ) : (
            <button
          ...
          <p className="text-md font-semibold text-gray-800 mt-6 text-center">
            Login with OTP{" "}
            <Link to="/mobilelogin" className="text-blue-500 cursor-pointer">
              Click here
            </Link>
          </p>
        </div>

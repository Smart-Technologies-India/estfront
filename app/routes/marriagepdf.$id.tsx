    ...
    const MarriagePdf = () => (
        <Document>
            <Page style={styles.body} size={'A4'} >
                ...
                <View style={styles.flexbox}>
                    <View style={styles.flexbox1}>
                        <Text style={styles.filenametext}>No.  EST-MRG-{`0000${form.id}`.substring(`0000${form.id}`.length - 4)}</Text>
                    </View>
                    <View style={styles.flexbox2}>
                    </View>
                    <View style={styles.flexbox3}>
                ...
                <View style={styles.dividertwo}></View>
                <View>
                    <Text style={styles.heading}>Marriage Event Permission</Text>
                </View>

                <View style={styles.dividerthree}></View>
                <View>
                    <Text style={styles.para}>Ref : EST-MRG-{`0000${form.id}`.substring(`0000${form.id}`.length - 4)}
                    </Text>
                </View>
                <View>
                    <Text style={styles.para}>Subject: Permission for Marriage Event
                    </Text>
                </View>

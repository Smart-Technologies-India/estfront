    ...
    <>
      <main className="bg-[#eeeeee] min-h-screen w-full pt-20">
        <div className="bg-[#03125e] w-full py-4 flex px-6 items-center fixed top-0 left-0">
          ...
          <Link
            to="/"
            className="border-2 border-white  px-4 py-1 flex gap-4 font-semibold text-lg rounded-md text-white items-center"
          >
            <MaterialSymbolsOtherHousesRounded></MaterialSymbolsOtherHousesRounded>{" "}
            HOME
          </Link>
        </div>
        <div className="p-4 mx-4 bg-white rounded-md my-6 border-l-4 border-[#03125e] hover:shadow-lg">
          <p className="text-black text-xl p-2 text-justify font-light">
            The Establishment Section Daman (EST Daman) is a statutory body
            constituted under Section 20 Daman & Diu Town and Country Planning
            (Amendment) Regulation, 1999 (Principal Act- Goa, Daman and Diu Town
            and Country Planning Act, 1974) in the year 2012.
          </p>
          <p className="text-black text-xl p-2 text-justify font-light">
            The Establishment Section Daman (EST Daman) is a statutory body
            constituted in the year 2012.
          </p>
        </div>
              ...
              <tbody>
                <tr className="bg-white border-b border-t transition duration-300 ease-in-out hover:bg-gray-100">
                  ...
                  <td className="text-sm text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                    The Collector/ District Magistrate, Daman
                  </td>
                </tr>
                <tr className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                  ...
                  <td className="text-sm text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                 The Deputy Collector (HQ)/ Sub Divisional Magistrate, Daman
                  </td>
                </tr>
                <tr className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                  ...
                  <td className="text-sm text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                   The Deputy Collector (Gen)/ Sub Divisional Magistrate, Daman
                  </td>
                </tr>
                <tr className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                  ...
                  <td className="text-sm text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                    Superintendent (Establishment), Collectorate, Daman
                  </td>
                </tr>
                <tr className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                  ...
                  <td className="text-sm text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                    LDC (Establishment), Collectorate, Daman
                  </td>
                </tr>
              </tbody>
            </table>
